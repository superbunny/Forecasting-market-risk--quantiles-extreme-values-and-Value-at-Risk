...
hold on
plot(ts3)
legend({'Daily negative log returns','RiskMetrics','Student-t-ARMA(1,1)-GARCH(1,1)'},'FontSize',10)
...
hold on
plot(ts5)
legend({'Daily negative log returns','Quantile','Quantile regression'},'FontSize',10)
